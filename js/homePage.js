    ...
    for (const empPayrollData of empPayrollList) {
        innerHtml += `
            <tr>
                ...
                <td>
                    <img name="${empPayrollData._id}" src="../assests/icons/delete-black-18dp.svg" alt="delete" onclick="remove(this)">
                    <img name="${empPayrollData._id}" src="../assests/icons/create-black-18dp.svg" alt="edit" onclick="update(this)">
                </td>
            </tr>
        `;
    }
    ...
    let empPayrollListLocal = [
        {
            ...
            _profileImage: '../assests/profile-images/Ellipse -3.png'
        },
        {
            _name: 'Harshal',
            _gender: 'Male',
